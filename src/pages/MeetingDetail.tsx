    ...
    <div className="p-8 max-w-7xl">
      ...
      <div className="grid grid-cols-12 gap-px bg-border rounded-lg overflow-hidden">
        ...
        <div className="col-span-3 bg-card p-5">
          ...
          {/* Slide Processing (frames + captions + aggregate) */}
          <div className="mt-6 pt-4 border-t border-border">
            <h2 className="text-[11px] uppercase text-muted-foreground font-mono-data tracking-wider mb-3">OCR klatek i dialogów</h2>
